...
const mobileAppsContent: MobileAppsContent = {
  hero: {
    breadcrumbCurrent: "Mobile Apps",
    eyebrow: "MOBILE APPS",
    headline: {
      lead: "Apps built for the floor,",
      emphasis: "not just the app store.",
    },
    description:
  ...
  inclusions: {
    ...
    heading: "Apps for every side of the business.",
    description:
      "Mobile development covers both what your customers see and what your team runs on.",
    items: [
      {
        id: "customer",
        title: "Customer-Facing Apps",
        description:
          "Ordering, booking, loyalty — branded apps your customers actually use.",
        icon: "customer",
      },
      {
        id: "backoffice",
        title: "Back-Office & Field Tools",
        description:
          "Inventory checks, dispatch, and reporting your team carries in their pocket.",
        icon: "backoffice",
      },
      {
        id: "cross-platform",
        title: "iOS & Android",
        description:
          "Native performance or cross-platform reach — built around your budget and timeline.",
        icon: "cross-platform",
      },
      {
        id: "offline",
        ...
        description:
          "Built to keep working in warehouses, job sites, and low-signal environments.",
        icon: "offline",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        title: "Discovery",
        description:
          "We map the workflow the app needs to support, on-site or on the floor.",
      },
      {
        id: "prototype",
        step: "02",
        ...
        description:
          "Clickable prototypes reviewed with your team before development starts.",
      },
      {
        id: "build",
        step: "03",
      ...
      },
      {
        ...
        description:
          "Device testing, store submission, and a documented handover to your team.",
      },
    ],
  },
  engagement: {
...
export function MobileAppsPage() {
  const content = mobileAppsContent;
...
function InclusionsSection({
  ...
  section: MobileAppsContent["inclusions"];
}) {
  return (
...
function ProcessSection({
  ...
  section: MobileAppsContent["process"];
}) {
  return (
...
function EngagementSection({
  ...
  section: MobileAppsContent["engagement"];
}) {
  return (
    <section className="bg-muted/40 py-20 lg:py-24">

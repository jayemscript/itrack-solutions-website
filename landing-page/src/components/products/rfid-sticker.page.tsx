...
type FeatureIconKey = "tags" | "printing" | "durability" | "bulk";
type UseCaseIconKey =
  | "retail"
  | "asset-tracking"
  | "loss-prevention"
...
const rfidStickerContent: RFIDStickerContent = {
  hero: {
    breadcrumbCurrent: "RFID Stickers & Tags",
    eyebrow: "RFID STICKERS & TAGS",
    headline: {
      lead: "Track everything,",
      emphasis: "without slowing anyone down.",
    },
    description:
  ...
  features: {
    ...
    heading: "Tags matched to what they're tracking.",
    description:
      "RFID only works if the tag survives the environment and the reader can actually find it.",
    items: [
      {
        id: "tags",
        title: "Passive & Active Tags",
        description:
          "Battery-free labels for retail and inventory, powered tags for long-range asset tracking.",
        icon: "tags",
      },
      {
        id: "printing",
        title: "Custom Print & Encoding",
        description:
          "Tags printed and encoded with your SKU, asset ID, or barcode before they ship.",
        icon: "printing",
      },
      {
        id: "durability",
        title: "Durable Adhesives",
        description:
          "Options rated for cold storage, outdoor exposure, and repeated handling.",
        icon: "durability",
      },
      {
        id: "bulk",
        title: "Bulk Supply",
        description:
          "Ordered and replenished at the volume your inventory actually moves at.",
        icon: "bulk",
      },
    ],
  },
  useCases: {
    ...
    heading: "One tag technology, four different jobs.",
    description:
      "The same underlying tag, deployed differently depending on what it's tracking.",
    items: [
      {
        id: "retail",
        step: "01",
        ...
        description:
          "Real-time stock counts and shelf-level visibility without manual scans.",
        icon: "retail",
      },
      {
        id: "asset-tracking",
        ...
        description:
          "Equipment, tools, and fixed assets located and audited automatically.",
        icon: "asset-tracking",
      },
      {
        id: "loss-prevention",
        ...
        description:
          "Exit-gate tags flag items that shouldn't be leaving the building.",
        icon: "loss-prevention",
      },
      {
        id: "logistics",
        step: "04",
        ...
        description:
          "Pallets and shipments tracked from dock door to destination.",
        icon: "logistics",
      },
    ],
  },
  included: {
    ...
    heading: "Tags are half the system.",
    description:
      "Every RFID deployment includes what it takes for the tags to actually report back.",
    points: [
      {
        id: "readers",
        title: "Reader & antenna setup",
        description:
          "Fixed or handheld readers positioned and configured to actually catch every tag.",
      },
      {
        id: "integration",
        title: "Software integration",
        description:
          "Tag reads connected to your inventory, POS, or asset management system.",
      },
      {
        id: "placement",
        title: "Tag placement guidance",
        description:
          "Where and how tags go on so they read reliably, not just in testing.",
      },
    ],
  },
  closing: {
...
> = {
  retail: Store,
  "asset-tracking": Boxes,
  "loss-prevention": ShieldAlert,
  logistics: Truck,
};
...
export function RFIDStickerPage() {
  const content = rfidStickerContent;
...
function FeaturesSection({
  ...
  section: RFIDStickerContent["features"];
}) {
  return (
...
function UseCasesSection({
  ...
  section: RFIDStickerContent["useCases"];
}) {
  return (
...
function IncludedSection({
  ...
  section: RFIDStickerContent["included"];
}) {
  return (
    <section className="bg-muted/40 py-20 lg:py-24">

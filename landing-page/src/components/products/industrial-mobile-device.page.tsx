...
type FeatureIconKey = "rugged" | "battery" | "scanning" | "os";
type UseCaseIconKey =
  | "warehousing"
  | "field-service"
  | "retail"
...
interface IndustrialMobileDeviceContent {
  hero: ProductHero;
...
const industrialMobileDeviceContent: IndustrialMobileDeviceContent = {
  hero: {
    breadcrumbCurrent: "Industrial Mobile Devices",
    eyebrow: "INDUSTRIAL MOBILE DEVICES",
    headline: {
      lead: "Handhelds built for the floor,",
      emphasis: "not the front office.",
    },
    description:
  ...
  features: {
    ...
    heading: "Built to survive where they work.",
    description:
      "Every device is selected and configured for the environment it's actually going into.",
    items: [
      {
        id: "rugged",
        title: "Rugged by Design",
        description:
          "IP65/IP68-rated devices that handle drops, dust, and moisture on the job.",
        icon: "rugged",
      },
      {
        id: "battery",
        ...
        description:
          "Power that lasts a full shift, with hot-swap options for round-the-clock operations.",
        icon: "battery",
      },
      {
        id: "scanning",
        ...
        description:
          "Built-in barcode and RFID scanning, no separate accessory to carry or lose.",
        icon: "scanning",
      },
      {
        id: "os",
        ...
        description:
          "OS choice matched to your existing software and IT policy.",
        icon: "os",
      },
    ],
  },
  useCases: {
    ...
    heading: "Deployed on the floor, not the shelf.",
    description:
      "The same device line, configured differently depending on where it's going to work.",
    items: [
      {
        id: "warehousing",
        step: "01",
        ...
        description:
          "Picking, receiving, and inventory counts tracked in real time.",
        icon: "warehousing",
      },
      {
        id: "field-service",
        ...
        title: "Field Service",
        description:
          "Work orders, parts lookup, and signatures captured on-site.",
        icon: "field-service",
      },
      {
        id: "retail",
        ...
        title: "Retail Floor",
        description:
          "Price checks, stock lookups, and mobile checkout on the sales floor.",
        icon: "retail",
      },
      {
        id: "manufacturing",
        ...
        title: "Manufacturing",
        description:
          "Line tracking, quality checks, and asset scanning on the shop floor.",
        icon: "manufacturing",
      },
    ],
  },
  included: {
    ...
    heading: "The device is the easy part.",
    description:
      "Every deployment includes what it takes to actually put these to work.",
    points: [
      {
        id: "provisioning",
        title: "Provisioning & configuration",
        description:
          "Devices arrive enrolled, configured, and ready to hand to your team.",
      },
      {
        id: "integration",
        title: "System integration",
        description:
          "Connected to your POS, WMS, or business software before day one.",
      },
      {
        id: "training",
        title: "Onsite deployment & training",
        description:
          "Your team is walked through the devices before they're expected to use them.",
      },
    ],
  },
  closing: {
...
export function IndustrialMobileDevicePage() {
  const content = industrialMobileDeviceContent;
...
function FeaturesSection({
  ...
  section: IndustrialMobileDeviceContent["features"];
}) {
  return (
...
function UseCasesSection({
  ...
  section: IndustrialMobileDeviceContent["useCases"];
}) {
  return (
...
function IncludedSection({
  ...
  section: IndustrialMobileDeviceContent["included"];
}) {
  return (
    <section className="bg-muted/40 py-20 lg:py-24">

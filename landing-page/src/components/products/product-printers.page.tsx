...
type FeatureIconKey = "receipt" | "label" | "document" | "connectivity";
type UseCaseIconKey = "retail" | "kitchen" | "warehousing" | "back-office";
...
interface ProductPrintersContent {
  hero: ProductHero;
...
const productPrintersContent: ProductPrintersContent = {
  hero: {
    breadcrumbCurrent: "Printers",
    eyebrow: "PRINTERS",
    headline: {
      lead: "Printers that keep up with",
      emphasis: "however fast you're moving.",
    },
    description:
  ...
  features: {
    ...
    heading: "A printer for every part of the workflow.",
    description:
      "Matched to the station, the paper, and the speed it actually needs to run at.",
    items: [
      {
        id: "receipt",
        title: "Receipt Printers",
        description:
          "Fast thermal printing for checkout, kitchens, and customer-facing counters.",
        icon: "receipt",
      },
      {
        id: "label",
        ...
        description:
          "Durable labels for inventory, shipping, and asset tagging.",
        icon: "label",
      },
      {
        id: "document",
        title: "Document & Office Printers",
        description:
          "Standard and multifunction printers for the paperwork behind the counter.",
        icon: "document",
      },
      {
        id: "connectivity",
        title: "Network & USB Ready",
        description:
          "Wired, wireless, or shared setups matched to how your stations are laid out.",
        icon: "connectivity",
      },
    ],
  },
  useCases: {
    ...
    heading: "Configured for what it's printing.",
    description:
      "The same printer line, set up differently depending on the job.",
    items: [
      {
        id: "retail",
        step: "01",
        ...
        description:
          "Receipts printed instantly at every register, no lag at the line.",
        icon: "retail",
      },
      {
        id: "kitchen",
        ...
        title: "Kitchen & F&B",
        description:
          "Order tickets routed to the right printer, in the right station, automatically.",
        icon: "kitchen",
      },
      {
        id: "warehousing",
        ...
        description:
          "Labels printed on demand for inventory, pallets, and outbound shipments.",
        icon: "warehousing",
      },
      {
        id: "back-office",
        ...
        title: "Back Office",
        description:
          "Invoices, reports, and paperwork handled without a separate office setup.",
        icon: "back-office",
      },
    ],
  },
  included: {
    ...
    heading: "The printer is the last step, not the first.",
    description:
      "Every printer we deploy comes configured into the system it's printing for.",
    points: [
      {
        id: "drivers",
        title: "Driver & software setup",
        description:
          "Printers installed and paired with your POS or business software before go-live.",
      },
      {
        id: "routing",
        title: "Print routing configuration",
        description:
          "The right documents sent to the right printer automatically, not chosen manually every time.",
      },
      {
        id: "consumables",
        title: "Consumables & maintenance",
        description:
          "Paper, ribbon, and label supply guidance so a station never goes down mid-shift.",
      },
    ],
  },
  closing: {
...
export function ProductPrintersPage() {
  const content = productPrintersContent;
...
function FeaturesSection({
  ...
  section: ProductPrintersContent["features"];
}) {
  return (
...
function UseCasesSection({
  ...
  section: ProductPrintersContent["useCases"];
}) {
  return (
...
function IncludedSection({
  ...
  section: ProductPrintersContent["included"];
}) {
  return (
    <section className="bg-muted/40 py-20 lg:py-24">
